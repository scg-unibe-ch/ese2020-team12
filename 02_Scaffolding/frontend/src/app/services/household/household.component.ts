...
export class HouseholdComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.articleInfoService.getServiceCategory(4);
  }
  ...
  servSendFilter(): void {
    ...
    this.httpClient.get(environment.endpointURL + 'filter/provided-service/4?city=' + this.servLoc + '&lowerPrice=' + this.servLowerPrice + '&upperPrice=' + this.servUpperPrice + '&servicePer=' + this.radioFilter(this.servicePer))
      .subscribe(items => {
