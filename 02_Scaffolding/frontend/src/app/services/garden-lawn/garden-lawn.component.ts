...
export class GardenLawnComponent implements OnInit {
  ...
  servSendFilter(): void {
    ...
    this.httpClient.get(environment.endpointURL + 'filter/provided-service/3?city=' + this.servLoc + '&lowerPrice=' + this.servLowerPrice + '&upperPrice=' + this.servUpperPrice + '&servicePer=' + this.radioFilter(this.servicePer))
      .subscribe(items => {
